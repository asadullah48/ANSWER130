...
function replaceMinusPlus(equation) {
  return lodash.replace(equation, /\-\040*\+/gim, '- ');
}
...
function replaceOne(equation) {
  return lodash.replace(equation, /1(?=[A-Za-z(])]/gim, '');
}
...
var LinearFunction = /*#__PURE__*/function (_MathFunction) {
  ...
  _proto.generateSlopeInterceptVariances = function generateSlopeInterceptVariances(randRange) {
    var m = lodash.random(randRange.min, randRange.max, false);
    var b = lodash.random(randRange.min, randRange.max, false);
  ...
  _proto.generatePointSlopeVariances = function generatePointSlopeVariances(randRange) {
    var m = lodash.random(randRange.min, randRange.max, false);
    var y1 = lodash.random(randRange.min, randRange.max, false);
    var x1 = lodash.random(randRange.min, randRange.max, false);
  ...
  _proto.generateStandardVariances = function generateStandardVariances(randRange) {
    var a = lodash.random(randRange.min, randRange.max, false);
    var b = lodash.random(randRange.min, randRange.max, false);
    var c = lodash.random(randRange.min, randRange.max, false);
...
var QuadraticFunction = /*#__PURE__*/function (_MathFunction) {
  ...
  _proto.generateVertexVariances = function generateVertexVariances(randRange) {
    var a = lodash.random(randRange.min, randRange.max, false);
    var h = lodash.random(randRange.min, randRange.max, false);
    var k = lodash.random(randRange.min, randRange.max, false);
  ...
  _proto.generateFactoredVariances = function generateFactoredVariances(randRange) {
    var a = lodash.random(randRange.min, randRange.max, false);
    var p = lodash.random(randRange.min, randRange.max, false);
    var q = lodash.random(randRange.min, randRange.max, false);
...
var TrigonometricFunction = /*#__PURE__*/function (_MathFunction) {
  ...
  _proto.generateVariances = function generateVariances(subType, randRange) {
    ...
    var b = lodash.random(randRange.min, randRange.max, false);
    var c = lodash.random(randRange.min, randRange.max, false);
    var d = lodash.random(randRange.min, randRange.max, false);
...
//# sourceMappingURL=math-function-generator.cjs.development.js.map
